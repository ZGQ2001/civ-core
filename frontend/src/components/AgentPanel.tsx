...
export function AgentPanel() {
  return (
    <div className="p-4 flex flex-col gap-3 text-xs h-full">
      ...
      <ul className="text-vscode-text-dim leading-relaxed list-disc pl-5 space-y-1">
        <li>对话式调用工具（"用预设 X 跑一下这份 Excel"）</li>
        <li>出图后对结果做文字解读 / 异常诊断</li>
        <li>根据上下文推荐预设、规范条文</li>
      </ul>
      <div className="mt-auto pt-3 border-t border-vscode-border">
