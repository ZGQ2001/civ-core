...
export function AppLogo({ size = 18, className }: Props) {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={hex} x1="22" y1="14" x2="78" y2="86" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#3aa0e3" />
          <stop offset="1" stopColor="#0d5c93" />
        </linearGradient>
        <linearGradient id={beam} x1="50" y1="29" x2="50" y2="71" gradientUnits="userSpaceOnUse">
      ...
      <path d="M33,30 H67 V39 H56 V61 H67 V70 H33 V61 H44 V39 H33 Z" fill={`url(#${beam})`} />
      <g fill={`url(#${hex})`}>
