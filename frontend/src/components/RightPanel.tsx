...
export function RightPanel({ tabs, defaultActiveId, onClose }: Props) {
  ...
  return (
    <div className="bg-vscode-bg border-vscode-border flex h-full min-w-0 flex-col border-l">
      <div className="border-vscode-border flex h-8 shrink-0 items-center border-b pr-1">
        ...
        <button
          ...
          onClick={onClose}
          className="text-vscode-text-dim hover:bg-vscode-hover flex h-6 w-6 shrink-0 items-center justify-center rounded-[3px] hover:text-white"
        >
...
function TabBtn({
  ...
  return (
    <button
      ...
      title={tab.label}
      className={cn(
        'flex h-8 shrink-0 items-center gap-1.5 border-b-2 px-3 text-[11px] tracking-wider uppercase transition-colors',
        active
